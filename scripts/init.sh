...
echo "--- Plugins.File"
gitPackage "https://git-wip-us.apache.org/repos/asf/cordova-plugin-file.git" "r1.3.2"
echo "--- Plugins.Media"
...
echo "--- Plugins.StatusBar"
gitPackage "https://git-wip-us.apache.org/repos/asf/cordova-plugin-statusbar.git" "r0.1.9"
echo "--- Plugins.Camera"
